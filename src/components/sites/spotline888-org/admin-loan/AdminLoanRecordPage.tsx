...
import AdminLoanRecordContent from "./AdminLoanRecordContent";
...
export default function AdminLoanRecordPage() {
  ...
  return (
    <div className="admin-wrapper skin-green">
      {/* Main Top Header with loanRecord active tab */}
      <AdminHeader
      ...
      {/* Left Sidebar with activePath set to /loan_record */}
      <AdminSidebar
        isCollapsed={isSidebarCollapsed}
        activePath="/loan_record"
      />
