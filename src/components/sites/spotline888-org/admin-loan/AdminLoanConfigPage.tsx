...
import AdminLoanConfigContent from "./AdminLoanConfigContent";
...
export default function AdminLoanConfigPage() {
  ...
  return (
    <div className="admin-wrapper skin-green">
      {/* Main Top Header with loanConfig active tab */}
      <AdminHeader
      ...
      {/* Left Sidebar with activePath set to /loan_config */}
      <AdminSidebar
        isCollapsed={isSidebarCollapsed}
        activePath="/loan_config"
      />
