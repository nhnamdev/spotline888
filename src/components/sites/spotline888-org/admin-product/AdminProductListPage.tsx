...
import AdminProductListContent from "./AdminProductListContent";
...
export default function AdminProductListPage() {
  ...
  return (
    <div className="admin-wrapper skin-green">
      {/* Main Top Header with product active tab */}
      <AdminHeader
      ...
      {/* Left Sidebar with activePath set to /product/product */}
      <AdminSidebar
        isCollapsed={isSidebarCollapsed}
        activePath="/product/product"
      />
